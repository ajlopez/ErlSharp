namespace ErlSharp.Tests.Communication
{
    using System;
    using System.Collections;
    using System.Collections.Generic;
    using System.IO;
    using ErlSharp.Communication;
    ...
    public class TypeSerializerTests
    {
        ...
        public void GetPersonTypeFullName()
        {
            ...
            Assert.AreEqual("ErlSharp.Tests.Person", serializer.TypeName);
        }
        ...
        public void CreateSerializerByFullNameAndProperties()
        {
            ...
            var serializer = new TypeSerializer("ErlSharp.Tests.Person", properties);
